...
export type ObserverQuery = {
  observer?: ZenObservable.SubscriptionObserver<any> | null;
  query: string;
  variables: Record<string, any>;
  subscriptionState: SUBSCRIPTION_STATUS;
  subscriptionReadyCallback?: Function | null;
  subscriptionFailedCallback?: Function | null;
  startAckTimeoutId?: number | null;
};
